...
{
    public partial class UsuariosEditarForm : Form
    {
       Usuarios usuarios = null;


        public UsuariosEditarForm()
        {
            InitializeComponent();
        ...
        public UsuariosEditarForm(int id)
        {
            InitializeComponent();
            Application.DoEvents();
            ...
            usuarios = new UsuariosDAO().Buscar(id);
            IDUsuariotextBox.Enabled = false;
        ...
        private void GravarUsuariobutton_Click(object sender, EventArgs e)
        {
            ...
            var gravar = new UsuariosDAO().Salvar(usuarios);
